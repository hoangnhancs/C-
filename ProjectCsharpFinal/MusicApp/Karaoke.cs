...
namespace MusicApp
{
    public partial class Karaoke : Form
    {
        ...
        private void Karaoke_Load(object sender, EventArgs e)
        {
            ...
            if(MusicApp.loadKaraokeFormButton)
            {
                textBox_titleVideo.Text = MusicApp.nowPlayingPlaylist[0].Name + " karaoke";
                searchVideos(true);
                MusicApp.loadKaraokeFormButton = false;
            }
        }
        ...
        private void textBox_titleVideo_TextChanged(object sender, EventArgs e)
        {
            if (textBox_titleVideo.Text.Contains("\n"))
            {
                textBox_titleVideo.Text = textBox_titleVideo.Text.Replace("\n", "").Trim();
                button_searchVideo.PerformClick();
                textBox_titleVideo.Focus();
                textBox_titleVideo.SelectionStart = textBox_titleVideo.Text.Length;
            }
        }
    }
}
